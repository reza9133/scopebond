...
**Escrow that settles freelance milestone-acceptance disputes using GenLayer
validator consensus.**

Testnet-grade intelligent contract. No real funds, no custody outside the
chain, no claim of production readiness.
